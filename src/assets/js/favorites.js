        ...
        influencer.onclick = (influencer) => {
          ...
          //RESUMES SHOW INFLUENCER FUNCTION IF NOT INSTAGRAM BUTTON CLICK
            ...
            if (window.screen.width < 780) {
              ...
              let buttonMessage = '<a href="#" id="messageInfluencer" class="signup-btn nav-link btn text-white d-lg-block d-inline-block mb-lg-0 mb-3 sign-up-btn">Message</a>';
              ...
              let buttonJob = '<a href="#" id="inviteToJob" class="signup-btn nav-link btn text-white d-lg-block d-inline-block mb-lg-0 mb-3 sign-up-btn">Invite to Job</a>';
              let buttonMessage = '<a href="#" id="messageInfluencer" class="signup-btn nav-link btn text-white d-lg-block d-inline-block mb-lg-0 mb-3 sign-up-btn">Message</a>';
