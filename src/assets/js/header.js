          ...
          '<div class="userChatHeader">'+
            ...
            '<div class="notificationContainer">'+
              ...
              '<div class="notificationInfo">'+
                ...
                '</div>'+
              '</div>'+
              '<img onclick="campaignDropdownShow(this, ' + "'notification'" + ', event)" src="./assets/icons/ellipsis.svg" class="elipsis">'+
            '</div>'+
...
switch(pageTitle) {
  ...
  case "Ravyyn - Find Influencers" : document.getElementById("navFindInfluencersButton").classList.add("rustText");break;
